...
**2026-02-12 12:47 UTC:** Fixed: runtime now reads legacy top-level resolverPrefixes for backward compatibility and normalizes writes to resolvers.prefixes. Added ConfigFile compatibility tests, docs note, changelog, and validated with full npm test pass.
