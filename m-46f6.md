...
2. **Error patterns**: Consider a warning (not error) when a WhenExpression with a value-producing action (string literal, variable, function call) appears as a statement in an exe block — it's likely a mistake.
